function [paramPoints, perimeter] = pathLengthParameterisationSLAM( pointSet, in1, in2 )
%PATHLENGTHPARAMETERISATIONSLAM Parametrises the boundary into a number of evenly spaced points
%   Input:
